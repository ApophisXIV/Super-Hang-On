...
leak-test: $(PROGRAM)
	...
	@make clean
	@make
# @valgrind --suppressions=docs/suppressions_20222_tp1.supp --leak-check=full --track-origins=yes ./$(PROGRAM)
	@valgrind --suppressions=docs/suppressions_20222_tp1.supp --leak-check=full --track-origins=yes ./$(PROGRAM) 2> valgrind.log
	@echo -e '\n\033[1;36m=============================================================================\033[0m'
	@echo -e '\033[1;41m --> \033[0;1;34m Verificando leaks: \033[0m'
	@echo -e '\033[1;36m=============================================================================\033[0m'
	@if grep -q -c "ERROR SUMMARY: 0 errors" valgrind.log; then \
		echo '\033[1;41m --> \033[0;1;32m No hay leaks! \033[0m'; \
