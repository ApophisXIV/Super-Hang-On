...
// NOTE: Revisar el comentario en la funcion leer_ruta en rom.c para
// entender la decision de usar un array de 16 colores por cada paleta
...
#define ASFALTO_1       4
#define ASFALTO_2       5
#define LINEA_FIN_PISTA 7
#define CUADRO_1        12
#define CUADRO_2        13
#define LINEA_CARRIL    15

const pixel_t colores_ruta[][16] = {
    {0, 0, 0, 0, 0x666, 0x566, 0, 0xfff, 0, 0, 0, 0, 0xfff, 0xb00, 0, 0xfff},
    {0, 0, 0, 0, 0x556, 0x666, 0, 0xfff, 0, 0, 0, 0, 0xb00, 0xfff, 0, 0xfff},
    {0, 0, 0, 0, 0x666, 0x566, 0, 0xfff, 0, 0, 0, 0, 0xfff, 0xb00, 0, 0xfff},
    {0, 0, 0, 0, 0x556, 0x666, 0, 0xfff, 0, 0, 0, 0, 0xb00, 0xfff, 0, 0xfff},
};
